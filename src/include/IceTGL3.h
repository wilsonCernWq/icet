...
#define ICET_GL3_COLOR_DESCRIPTION         (ICET_GL3_STATE_START | (IceTEnum)0x0030)
#define ICET_GL3_DEPTH_RESOURCE            (ICET_GL3_STATE_START | (IceTEnum)0x0031)
#define ICET_GL3_DEPTH_DESCRIPTION         (ICET_GL3_STATE_START | (IceTEnum)0x0032)
#define ICET_GL3_SPARSE_GPU_BUFFER         (ICET_GL3_STATE_START | (IceTEnum)0x0033)
